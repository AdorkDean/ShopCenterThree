...
@interface TJ_HomeHeaderSortThreeView ()
...
@end
@implementation TJ_HomeHeaderSortThreeView
...
- (void)TJ_setupUI {
    ...
    UILabel *titleLabel = [UILabel XTJ_createWithTitle:@"分类三" titleColor:[UIColor blackColor] font:12 textAlignment:NSTextAlignmentCenter];
...
//        make.left.equalTo(weakSelf);
//        make.width.equalTo(weakSelf.width).multipliedBy(0.5);
//        make.height.equalTo(weakSelf.height).offset(-60).multipliedBy(0.5);
//    }];
